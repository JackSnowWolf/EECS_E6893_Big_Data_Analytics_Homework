...
SELECT COALESCE(t1.time, t2.time) as time, IFNULL(data, 0) as data , IFNULL(ai, 0) as ai,
IFNULL(good, 0) as good , IFNULL(movie, 0) as movie, IFNULL(spark, 0) as spark
FROM
(SELECT COALESCE(t1.time, t2.time) as time, IFNULL(data, 0) as data , IFNULL(ai, 0) as ai,
IFNULL(good, 0) as good , IFNULL(movie, 0) as movie
FROM
(SELECT COALESCE(t1.time, t2.time) as time, IFNULL(data, 0) as data , IFNULL(ai, 0) as ai
...
FULL OUTER JOIN
(SELECT COALESCE(t1.time, t2.time) as time, IFNULL(good, 0) as good , IFNULL(movie, 0) as movie
